...
# PARAMETROS
#######################################################################################
nameDAG = 'mapfre-from-oracle-to-aws-and-azure-dynamically'
owner = 'mapfre'
...
def create_dag(dag_id,
    ...
    with dag:
        ...
        t_begin >> [t_move_data_from_oracle_to_aws, t_move_data_from_oracle_to_azure_datalake]

        [t_move_data_from_oracle_to_aws, t_move_data_from_oracle_to_azure_datalake] >> t_send_email_OK

        t_send_email_OK >> t_end
