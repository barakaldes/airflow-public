...
def create_dag(dag_id,
    ...
    with dag:
        ...
        t_move_data_from_oracle_to_azure_datalake = OracleToAzureDataLakeGen2Operator(
            task_id="move_data",
            azure_data_lake_conn_id="oracle-to-azure__datalake_connection",
            azure_data_lake_container=Variable.get("oracle-to-azure__azure-data-lake-container"),
            oracle_conn_id="oracle-to-azure__oracle_connection",
            filename=Variable.get("oracle-to-azure__filename"),
            azure_data_lake_path=Variable.get("oracle-to-azure__azure-data-lake-path"),
            sql=query,
            sql_params=None,
            delimiter=";",
            encoding="utf-8",
